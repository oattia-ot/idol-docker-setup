...
if $IS_DOWN; then
    ...
    if (( LLM_EXIT == 0 )); then
        ...
        ANSWERSERVER_CFG="/home/kduser3/idol-docker-setup/persistent-data/answerserver/cfg/answerserver.cfg"
...
if $IS_UP; then
    ...
    export COMMUNITY_PORT="${PORT_DATA_ADMIN_COMMUNITY:-9033}"
    export COMMUNITY_CERT="./ssl/intermediate/certs/ca-chain.cert.pem"
