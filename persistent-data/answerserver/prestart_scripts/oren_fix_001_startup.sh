...
_IDOL_DATAADMIN_CONTENT_HOST=${IDOL_DATAADMIN_CONTENT_HOST:-idol-dataadmin-content}
_IDOL_DATAADMIN_CONTENT_PORT=${PORT_DATA_ADMIN_DATAADMIN_CONTENT:-9103}
_IDOL_DATAADMIN_AGENTSTORE_HOST=${IDOL_DATAADMIN_AGENTSTORE_HOST:-idol-dataadmin-agentstore}
_IDOL_DATAADMIN_AGENTSTORE_PORT=${PORT_DATA_ADMIN_DATAADMIN_AGENTSTORE:-12310}
...
function finalizeConfigFile {
    ...
    sed -i "s|idol-dataadmin-content|${_IDOL_DATAADMIN_CONTENT_HOST}|g" "$CONFIG_FILE"
    sed -i "s|IdolAciPort=9100|IdolAciPort=${_IDOL_DATAADMIN_CONTENT_PORT}|g" "$CONFIG_FILE"
    sed -i "s|idol-dataadmin-agentstore|${_IDOL_DATAADMIN_AGENTSTORE_HOST}|g" "$CONFIG_FILE"
    sed -i "s|AgentstoreAciPort=12310|AgentstoreAciPort=${_IDOL_DATAADMIN_AGENTSTORE_PORT}|g" "$CONFIG_FILE"
...
waitForAci "${_IDOL_DATAADMIN_CONTENT_HOST}:${_IDOL_DATAADMIN_CONTENT_PORT}"
