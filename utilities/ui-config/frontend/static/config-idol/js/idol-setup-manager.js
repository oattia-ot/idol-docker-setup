...
function updateInfoSectionUrls() {
  ...
  const p = {
    ...
    daContent: port('dataadminContentPort', 9103),
  ...
  setLink('dyn-dataadminagent-link', `https://${HOST}:${p.dataadminAgent}/a=admin`, 'dyn-dataadminagent-copy');
  ...
  const grlMap = {
    ...
    'dataadmincontent-da': { proto: 'https', portKey: 'daContent',       path: '/a=grl' },
