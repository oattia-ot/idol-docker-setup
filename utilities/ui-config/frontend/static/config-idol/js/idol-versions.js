 ...
 *
 * Note: Data Admin no longer has its own version selector — it always
 * tracks whatever version is chosen for #basic-idol-version (see
 * idol-setup-manager.js, IDOL_DATA_ADMIN_VERSION).
 */
  ...
  function init() {
    fetch(JSON_PATH)
      ...
      .then(({ versions }) => {
        ...
        // 2. Rich Media — selects newest version where richMediaStable:true
        populateSelect(
          "rich-media-version",
          versions,
