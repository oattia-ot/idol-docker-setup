...
#not enabling Python  ${nifi_props_file}
prop_replace 'nifi.python.extensions.source.directory.default'  "${NIFI_HOME}/python_extensions"
# Setup NiFi to scan for new NARs in extensions
prop_replace 'nifi.nar.library.autoload.directory'  "${NIFI_HOME}/extensions"
...
# Enable HTTP connections (NiFi2 start script does not include this section, hence this version of the script)
